...
proc update_PARAM_VALUE.t_0 { PARAM_VALUE.t_0 } {
	# Procedure called to update t_0 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.t_0 { PARAM_VALUE.t_0 } {
	# Procedure called to validate t_0
	return true
}

proc update_PARAM_VALUE.t_1 { PARAM_VALUE.t_1 } {
	# Procedure called to update t_1 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.t_1 { PARAM_VALUE.t_1 } {
	# Procedure called to validate t_1
	return true
}

proc update_PARAM_VALUE.t_2 { PARAM_VALUE.t_2 } {
	# Procedure called to update t_2 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.t_2 { PARAM_VALUE.t_2 } {
	# Procedure called to validate t_2
	return true
}

proc update_PARAM_VALUE.t_3 { PARAM_VALUE.t_3 } {
	# Procedure called to update t_3 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.t_3 { PARAM_VALUE.t_3 } {
	# Procedure called to validate t_3
	return true
}

proc update_PARAM_VALUE.t_4 { PARAM_VALUE.t_4 } {
	# Procedure called to update t_4 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.t_4 { PARAM_VALUE.t_4 } {
	# Procedure called to validate t_4
	return true
}

proc update_PARAM_VALUE.t_5 { PARAM_VALUE.t_5 } {
	# Procedure called to update t_5 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.t_5 { PARAM_VALUE.t_5 } {
	# Procedure called to validate t_5
	return true
}

proc update_PARAM_VALUE.t_6 { PARAM_VALUE.t_6 } {
	# Procedure called to update t_6 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.t_6 { PARAM_VALUE.t_6 } {
	# Procedure called to validate t_6
	return true
}
...
proc update_MODELPARAM_VALUE.t_0 { MODELPARAM_VALUE.t_0 PARAM_VALUE.t_0 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.t_0}] ${MODELPARAM_VALUE.t_0}
}

proc update_MODELPARAM_VALUE.t_1 { MODELPARAM_VALUE.t_1 PARAM_VALUE.t_1 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.t_1}] ${MODELPARAM_VALUE.t_1}
}

proc update_MODELPARAM_VALUE.t_2 { MODELPARAM_VALUE.t_2 PARAM_VALUE.t_2 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.t_2}] ${MODELPARAM_VALUE.t_2}
}

proc update_MODELPARAM_VALUE.t_3 { MODELPARAM_VALUE.t_3 PARAM_VALUE.t_3 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.t_3}] ${MODELPARAM_VALUE.t_3}
}

proc update_MODELPARAM_VALUE.t_4 { MODELPARAM_VALUE.t_4 PARAM_VALUE.t_4 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.t_4}] ${MODELPARAM_VALUE.t_4}
}

proc update_MODELPARAM_VALUE.t_5 { MODELPARAM_VALUE.t_5 PARAM_VALUE.t_5 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.t_5}] ${MODELPARAM_VALUE.t_5}
}

proc update_MODELPARAM_VALUE.t_6 { MODELPARAM_VALUE.t_6 PARAM_VALUE.t_6 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.t_6}] ${MODELPARAM_VALUE.t_6}
}
